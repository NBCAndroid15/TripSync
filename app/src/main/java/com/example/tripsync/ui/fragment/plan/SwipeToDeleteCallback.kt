...
class SwipeToDeleteCallback(private val recyclerViewAdapter : PlanListAdapter)  : ItemTouchHelper.Callback() {
...
//        recyclerViewAdapter.swapItem(fromPos, toPos)
        return true
    }
...
//         recyclerViewAdapter.deleteItem(viewHolder.layoutPosition)
    ...
    override fun clearView(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder) {
        ...
        previousPosition = viewHolder.absoluteAdapterPosition       // 드래그 또는 스와이프 동작이 끝난 view의 position 기억하기
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        viewHolder?.let {
            currentPosition = viewHolder.absoluteAdapterPosition    // 현재 드래그 또는 스와이프 중인 view 의 position 기억하기
