...
* */
    ...
    fun initPlan(title: String, size: Int, dateList: List<String>) {
        viewModelScope.launch {
            val curUser = com.trip.tripsync.data.AuthRepositoryImpl().getCurrentUserInfo()
    ...
    fun initPlan(plan: Plan) {
        viewModelScope.launch {
            _plan = plan
            _userList.value =
                com.trip.tripsync.data.AuthRepositoryImpl().getUserListByUidList(plan.group ?: listOf()) ?: listOf()
        }
    }
